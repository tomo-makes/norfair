...
import numpy as np
import torch
import pickle # to save homography matrix
...
def run():
    ...
    tracked_objects = []
    homography_matrix_list = [] # to save homography matrix
    ...
    for input_path in args.files:
        ...
        for frame in video:
            ...
            # append homography matrix
            homography_matrix_list.append(coord_transformations.homography_matrix)
        ...
        # pickle homography matrix
        with open('JPN-ESP_homography_matrix_list.pkl', 'wb') as p:
            pickle.dump(homography_matrix_list,p)
